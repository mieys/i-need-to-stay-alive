...
<tileset version="1.10" tiledversion="1.11.0" name="Fireplace" tilewidth="48" tileheight="64" tilecount="6" columns="6">
 <image source="Fireplace.png" width="288" height="64"/>
 <tile id="0">
  <animation>
